...
namespace KdtSdk.Models
{
    public class KondutoDevice : KondutoModel
    {
	    ...
	    public override bool Equals(Object o) 
        {
            ...
            if (!object.Equals(Provider, that.Provider)) return false;
            ...
            if (!object.Equals(Manufacturer, that.Manufacturer)) return false;
            if (!object.Equals(Os, that.Os)) return false;
