    ...
    public class KondutoOrderFactory
    {
        public static KondutoOrder completeOrder()
        {
            return new KondutoOrder
            {
                ...
                BureauxQueries = KondutoBureauxQueriesFactory.Create(),
                TriggeredRules = KondutoTriggeredRulesFactory.Create(),
                TriggeredDecisionList = KondutoTriggeredDecisionListFactory.Create(),
